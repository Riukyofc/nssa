      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          {packages.map((pkg, i) => (
            ...
            >
              ...
              <div className="mt-auto pt-4 w-full">
                <a href="https://discord.gg/vZqXX59NsA" target="_blank" rel="noopener noreferrer" className={`w-full flex items-center justify-center py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all duration-300 ${
                  pkg.popular
        ...
        >
          <div className="relative inline-flex group">
            ...
            <a href="https://discord.gg/vZqXX59NsA" target="_blank" rel="noopener noreferrer" className="relative h-14 px-10 rounded-full bg-gradient-to-r from-emerald-500 to-green-500 text-black font-bold flex items-center justify-center gap-2 hover:brightness-110 transition-all animate-glow-pulse z-10">
