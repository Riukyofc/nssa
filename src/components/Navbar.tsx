...
const NAV_LINKS = [
  ...
  { label: 'Jogos', href: '#jogos', id: 'jogos' },
  { label: 'O App', href: '#o-app', id: 'o-app' },
  { label: 'VIP', href: '#vip', id: 'vip' }
];
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <motion.div 
          ...
          onClick={(e) => handleScrollTo(e as any, '#root')}
        >
          ...
          <div className="text-[8px] tracking-[0.2em] text-gray-400 mt-0.5 uppercase">E-SPORTS APP</div>
        </motion.div>
        ...
        >
          ...
          <button className="h-10 px-6 rounded-full bg-gradient-to-r from-emerald-500 to-green-500 text-black font-bold text-sm hover:brightness-110 transition-all animate-glow-pulse">
            Acessar Sistema
          </button>
        </motion.div>
        ...
        {isOpen && (
          ...
          >
            <div className="px-6 py-4 flex flex-col gap-4">
              ...
              <button className="h-12 w-full rounded-full bg-gradient-to-r from-emerald-500 to-green-500 text-black font-bold text-sm hover:brightness-110 transition-all mt-4 animate-glow-pulse shadow-[0_0_20px_rgba(16,185,129,0.3)]">
                Acessar Sistema
              </button>
            </div>
          </motion.div>
